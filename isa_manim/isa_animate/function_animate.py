...
def read_func_imm(elem: ElemUnit) -> Animation:
    """
    Animation for declare one immediate operand. Fade in element at the specified
    location related to the function unit.
...
def function_call(
    ...
    src_animates = [
        FadeOut(
            arg, shift=func_unit.func_rect.get_center() -
    ...
    dst_animates = [
        FadeIn(
            res, shift=func_unit.get_res_pos(i, offset, res.elem_width) -
