...
from manim import Text, ORIGIN, UP, DOWN, RIGHT, ZoomedScene, BLACK, config
...
class SingleIsaScene(ZoomedScene, IsaDataFlow):
    ...
    def __init__(self, **kwargs):
        ...
        ZoomedScene.__init__(
            self, zoom_factor=1.0, zoomed_display_height=config.frame_height / 2 + 3,
    ...
    def end_section(self, wait: int = 1, fade_out: bool = True):
        """
        ...
        self.switch_section(wait=wait, fade_out=fade_out, camera_animate=camera_animate)
