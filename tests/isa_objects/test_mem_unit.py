...
class TestMemoryUnit(Scene):
    ...
    def construct(self):
        ...
        addr_up_brace = BraceBetweenPoints(mem_unit.addr_rect.get_left() + UP * 0.5,
                                           mem_unit.addr_rect.get_right() + UP * 0.5,
                                           color=GREEN,
                                           direction=UP)
        addr_up_brace_text = \
        ...
        addr_up_space_brace = BraceBetweenPoints(mem_unit.addr_rect.get_right() + UP * 0.5,
                                                 mem_unit.addr_rect.get_right() + UP * 0.5 + RIGHT,
                                                 color=GREEN,
                                                 direction=UP)
        ...
        data_up_brace = BraceBetweenPoints(mem_unit.data_rect.get_left() + UP * 0.5,
        ...
        data_up_space_brace = BraceBetweenPoints(mem_unit.data_rect.get_left() + UP * 0.5 + LEFT,
                                                 mem_unit.data_rect.get_left() + UP * 0.5,
                                                 color=GREEN,
                                                 direction=UP)
        ...
        mem_rect_label = \
            Text("mem_rect", color=YELLOW).move_to(mem_unit.mem_rect.get_left() + LEFT * 4 + UP * 4)
        ...
        addr_rect_label = \
            Text("addr_rect", color=YELLOW).move_to(mem_unit.addr_rect.get_top() + UP * 3)
        addr_rect_arrow = Arrow(
            addr_rect_label.get_bottom(), mem_unit.addr_rect.get_top(), color=YELLOW)
        self.add(addr_rect_label, addr_rect_arrow)

        data_rect_label = \
            Text("data_rect", color=YELLOW).move_to(mem_unit.data_rect.get_top() + UP * 3)
        data_rect_arrow = Arrow(
            data_rect_label.get_bottom(), mem_unit.data_rect.get_top(), color=YELLOW)
