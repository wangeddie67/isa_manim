...
class TestMemoryUnitDualPort(Scene):
    ...
    def construct(self):
        ...
        mem_up_brace_text = mem_up_brace.get_text(str(
            mem_unit.mem_rect.width)).set_color(GREEN)
        ...
        data_up_brace_text = data_up_brace.get_text(str(
            mem_unit.data_rect.width)).set_color(GREEN)
        ...
        data_down_brace_text = data_down_brace.get_text(str(
        ...
        mem_map_down_brace_text = (
            mem_map_down_brace.get_text(
                f"Scene : {mem_unit.mem_map_list[0].width}").set_color(GREEN).shift(
                    UP * 0.25))
