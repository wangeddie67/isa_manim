...
from isa_manim import (
    ...
    FunctionUnit, MemoryUnit, Dot, NumberPlane, IsaPlacementMap)
    ...
    def construct(self):
        ...
        func16_unit_list = [
            FunctionUnit(
                ...
                get_config("elem_value_format"), None) for _ in range(0, 8)
        ]
        ...
        animation_map.place_object_group(
            func16_unit_list, func16_hash_list, force_hw_ratio=8)
        animation_map.place_object_group(func32_unit_list, func32_hash_list)

        mem_unit = MemoryUnit(
            WHITE, 64, 64, 64, [[0, 0x100]], DEFAULT_FONT_SIZE,
            get_config("elem_value_format"), False, 0,
            animation_map.get_placement_width() - 2, True)
